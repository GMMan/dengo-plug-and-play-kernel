...
#ifdef CONFIG_USB_G_ANDROID_HID
...
#ifdef CONFIG_USB_G_ANDROID_CLOVER
#include "f_clover.c"
#endif
#ifdef CONFIG_USB_G_ANDROID_FS
#include "f_fs.c"
#endif
#ifdef CONFIG_USB_G_ANDROID_HID
#include "f_hid.c"
#endif
#ifdef CONFIG_USB_G_ANDROID_AUDIO_SOURCE
...
#ifdef CONFIG_USB_SUNXI_USB_GADGET_FORCE_SET_DESCRIPTOR
	.iManufacturer        = 0,
	.iProduct             = 0,
	.iSerialNumber        = 0,
#endif
...
static struct usb_configuration android_config_driver = {
	...
	.bMaxPower	= 0xfa,
        /* initially modified from 500ma down to 224ma to support levono win7 mass_storage in usb3.0 by wangjx 2014-3-20 */
        /* back to 500mA as CLOVER can use up to that many Amps */
};
...
#endif /* #ifdef CONFIG_USB_G_ANDROID_FS */
...
#endif /* CONFIG_USB_G_ANDROID_ADB */
...
#endif /* #ifdef CONFIG_USB_G_ANDROID_ACM */
...
#endif /* CONFIG_USB_G_ANDROID_MTP */
...
#endif /* CONFIG_USB_G_ANDROID_RNDIS */
...
#endif /* CONFIG_USB_G_ANDROID_MASS_STORAGE */
...
#endif /* CONFIG_USB_G_ANDROID_ACCESSORY */
...
static int clover_presence_function_init(struct android_usb_function *f,
					struct usb_composite_dev *cdev)
{
	f->config = kzalloc(sizeof(struct clover_function_config), GFP_KERNEL);
	if (!f->config)
		return -ENOMEM;
...
static void clover_presence_function_cleanup(struct android_usb_function *f)
{
	clover_cleanup();
...
static int clover_presence_function_bind_config(struct android_usb_function *f,
						struct usb_configuration *c)
{
...
static struct android_usb_function clover_presence_function = {
	.name		= "clover",
	.init		= clover_presence_function_init,
	.cleanup	= clover_presence_function_cleanup,
	.bind_config	= clover_presence_function_bind_config,
	.ctrlrequest	= clover_presence_function_ctrlrequest,
	.attributes	= clover_presence_function_attributes,
};

#endif /* CONFIG_USB_G_ANDROID_CLOVER */
...
#endif /* CONFIG_USB_G_ANDROID_AUDIO_SOURCE */
...
#endif /* CONFIG_USB_G_ANDROID_HID */
...
#ifndef CONFIG_USB_SUNXI_USB_GADGET_FORCE_SET_DESCRIPTOR
